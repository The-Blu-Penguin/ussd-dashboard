...
<template>
  <div v-if="authStore.user?.role === 'ADMIN'" class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm md:col-span-2 border border-transparent dark:border-gray-700">
